        ...
        >
          <div className="bg-surface rounded-2xl p-8 shadow-sm border border-subtle mb-8">
            <div className="flex items-start gap-6">
              <div className="w-20 h-20 bg-green-700 rounded-2xl flex items-center justify-center flex-shrink-0">
          ...
          <div className="bg-surface rounded-2xl p-8 shadow-sm border border-subtle">
            ...
            <div className="space-y-4">
              ...
              <motion.button
                ...
                className="cursor-pointer w-full bg-green-700 hover:bg-green-800 text-white font-semibold text-[16px] h-[52px] rounded-xl shadow-md hover:shadow-lg transition-all"
